...
namespace Extract.FileActionManager.Forms.Test
{
    ...
    public class TestFileActionManagerPathTags
    {
        ...
        /// </summary>
        static FileActionManagerPathTags _fileTags;
        ...
        public static void Initialize()
        {
            ...
            FAMTagManager famTagManager = new FAMTagManager();
            famTagManager.FPSFileDir = _FPS_FILE_DIR;
            famTagManager.FPSFileName = _FPS_FILE_NAME;

            _fileTags = new FileActionManagerPathTags(famTagManager, _TEST_FILE_PATH);
        }
        ...
        public static void SourceDocName()
        {
        ...
        /// </summary>
        [Test, Category("Automated")]
        public static void FpsFileName()
        {
        ...
        /// </summary>
        [Test, Category("Automated")]
        public static void ChangeExtNoExt()
        {
        ...
        /// </summary>
        [Test, Category("Automated")]
        public static void ChangeExtWithExt()
        {
        ...
        /// </summary>
        [Test, Category("Automated")]
        public static void DirNoDriveOf()
        {
        ...
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly",
            MessageId = "Env")]
        public static void EnvDoesNotExist()
        {
        ...
        /// </summary>
        [Test, Category("Automated")]
        public static void FileNoExtOf()
        {
        ...
        /// </summary>
        [Test, Category("Automated")]
        public static void FullUserName()
        {
        ...
        /// </summary>
        [Test, Category("Automated")]
        public static void InsertBeforeExt()
        {
        ...
        /// </summary>
        [Test, Category("Automated")]
        public static void InsertBeforeExtException()
        {
        ...
        [Test, Category("Automated")]
        public static void Left([Values("123456789")] string value,
        ...
        public static void LeftBadInput([Values("test", "test", "test", @"c:\test\test,filename.tif")] string value,
        ...
        [Test, Sequential, Category("Automated")]
        public static void Now([Values("", "%m/%d/%Y %H:%M")] string format,
        ...
        /// </summary>
        [Test, Sequential, Category("Automated")]
        public static void Offset([Random(1, 23000, 5)] int value,
        ...
        /// </summary>
        [Test, Category("Automated")]
        public static void PadValue([Values("12345")] string value,
        ...
        [Test, Category("Automated")]
        public static void Right([Values("123456789")] string value,
            [Values(3,5,7,9,11)] int count)
        {
        ...
        /// <param name="count">The value to pass as an argument to the Left function.</param>
        [Test, Sequential, Category("Automated")]
        public static void RightBadInput([Values("test", "test", "test", @"c:\test\test,filename.tif")] string value,
            [Values("-1", "0", "a", "3")] string count)
        {
        ...
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly",
            MessageId = "AlphaNumeric")]
        public static void RandomAlphaNumericProperFormat()
        {
        ...
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly",
            MessageId = "AlphaNumeric")]
        public static void RandomAlphaNumericProperLength([Values(5, 7, 9, 11, 13)] int length)
        {
        ...
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly",
            MessageId = "AlphaNumeric")]
        public static void RandomAlphaNumericException()
        {
            try
            {
        ...
        /// </summary>
        [Test, Category("Automated")]
        public static void TrimAndConsolidateWS([Values("\t\n\r\nThis is  A \t test\r\nstring",
        ...
        /// </summary>
        [Test, Sequential, Category("Automated")]
        public static void AlternateDelimiterSyntax([Values("InsertBeforeExt", "Offset", "PadValue",
        ...
        /// </summary>
        [Test, Category("Automated")]
        public static void ExtraParentheses()
        {
            string tag = @"($UserName())";
            Assert.That(_fileTags.Expand(tag).Equals("(" + Environment.UserName + ")"));
        }

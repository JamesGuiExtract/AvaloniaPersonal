...
START "" "C:\Program Files (x86)\Extract Systems\CommonComponents\ProcessFiles.exe" TransformXML.fps /s

REM Start Logging Statistics every minute to a numbered subfolder
"C:\Program Files (x86)\Extract Systems\CommonComponents\LogProcessStats.exe" ProcessFiles 1m .\Stats\Test /el

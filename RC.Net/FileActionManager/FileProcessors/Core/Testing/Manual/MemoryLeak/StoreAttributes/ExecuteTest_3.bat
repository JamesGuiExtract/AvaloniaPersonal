...
START "" "%CommonComponentsDir%\ProcessFiles.exe" 3_StoreAttributes_NoSpatial_NoEmpty.fps /s

:: Start Logging Statistics every minute to a numbered subfolder
"%CommonComponentsDir%\LogProcessStats.exe" ProcessFiles 1m .\Stats\Test_3 /el

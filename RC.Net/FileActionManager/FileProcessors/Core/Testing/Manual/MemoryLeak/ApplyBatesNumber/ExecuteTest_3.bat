...
START "%CommonComponentsDir%\ProcessFiles.exe" 3_ApplyBatesNewNumberEachDocumentPdf.fps /s

:: Start Logging Statistics every minute to a numbered subfolder
"%CommonComponentsDir%\LogProcessStats" ProcessFiles 1m .\Stats\Test_3 /el

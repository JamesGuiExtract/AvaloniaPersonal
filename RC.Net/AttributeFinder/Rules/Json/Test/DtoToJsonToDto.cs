...
namespace Extract.AttributeFinder.Rules.Json.Test
{
    ...
    public class DtoToJsonToDto
    {
        #region Fields

        static TestFileManager<DtoToJsonToDto> _testFiles;
        ...
        public static void Setup()
        {
            ...
            _testFiles = new TestFileManager<DtoToJsonToDto>();
        }
        ...
        /// <summary>
        /// Load example binary RSD files, convert to DTO, save as JSON, and reload to DTO. Compare the DTO object from JSON with the DTO object from the Domain.
        /// </summary>
        ...
        public static void ExampleRuleObjects(string resourceName)
        {
            ...
            foreach (var line in lines)
            {
                ...
                var (json, dtoFromDomain) = RuleObjectJsonSerializer.Serialize<IObjectWithDescription, Dto.ObjectWithDescription>(owd);
                var (_owdFromJson, dtoFromJson) = RuleObjectJsonSerializer.DeserializeIncludeIntermediateObject<ObjectWithDescriptionClass>(json);

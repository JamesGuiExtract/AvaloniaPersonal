    ...
    public partial class DuplicateAndSeparateTreesSettingsDialog : Form
    {
        ...
        public DuplicateAndSeparateTreesSettingsDialog(DuplicateAndSeparateTrees settings)
        {
            try
            {
                ...
                LicenseUtilities.ValidateLicense(LicenseIdName.FileActionManagerObjects, "ELI33472",
                    _OBJECT_NAME);
        ...
        protected override void OnLoad(EventArgs e)
        {
            try
            {
                ...
                if (Settings != null)
                {
                    _attributeSelectorControl.AttributeSelector = Settings.AttributeSelector;
        ...
        void HandleOkButtonClick(object sender, EventArgs e)
        {
            try
            {
                ...
                Settings.AttributeSelector = _attributeSelectorControl.AttributeSelector;
        ...
        bool WarnIfInvalid()
        {
            if (_attributeSelectorControl.AttributeSelector == null)
            {
            ...
            IMustBeConfiguredObject configurable =
                _attributeSelectorControl.AttributeSelector as IMustBeConfiguredObject;

...
namespace Extract.ETL.Test
{
    ...
    public class TestRedactionAccuracyServices
    {
        ...
        {
            (1 ,  11,  1 ,  1,   "SSN", 2,   2,   2,   0,   0,   0,   0),
            (2 ,  12,  2 ,  1,   "SSN", 2,   3,   2,   0,   0,   0,   0),
            (3 ,  13,  3 ,  1,   "SSN", 2,   2,   1,   0,   0,   1,   1),
            (4 ,  14,  4 ,  1,   "SSN", 3,   2,   2,   0,   0,   0,   1),
            (5 ,  15,  5 ,  1,   "SSN", 1,   1,   1,   0,   0,   0,   0),
            (6 ,  16,  6 ,  1,   "SSN", 2,   2,   1,   0,   0,   1,   1),
            (7 ,  17,  7 ,  1,   "SSN", 1,   1,   1,   0,   0,   0,   0),
            (8 ,  18,  8 ,  1,   "SSN", 1,   1,   1,   0,   0,   0,   0),
            (9 ,  19,  9 ,  1,   "SSN", 2,   3,   1,   0,   0,   2,   1),
            (10,  20,  10,  1,   "SSN", 2,   2,   2,   0,   0,   0,   0)
        };
        ...
        {
            (1 ,  21,  1 ,  1,   "SSN", 2,   2,   2,   0,   0,   0,   0),
            (2 ,  22,  2 ,  1,   "SSN", 2,   3,   2,   0,   0,   0,   0),
            (3 ,  23,  3 ,  1,   "SSN", 2,   2,   1,   0,   0,   1,   1),
            (4 ,  24,  4 ,  1,   "SSN", 3,   2,   2,   0,   0,   0,   1),
            (5 ,  25,  5 ,  1,   "SSN", 1,   1,   1,   0,   0,   0,   0),
            (6 ,  26,  6 ,  1,   "SSN", 2,   2,   0,   0,   0,   2,   2),
            (7 ,  27,  7 ,  1,   "SSN", 1,   1,   1,   0,   0,   0,   0),
            (8 ,  28,  8 ,  1,   "SSN", 1,   1,   1,   0,   0,   0,   0),
            (9 ,  29,  9 ,  1,   "SSN", 2,   3,   1,   0,   0,   2,   1),
            (10,  30,  10,  1,   "SSN", 2,   2,   2,   0,   0,   0,   0)
        };

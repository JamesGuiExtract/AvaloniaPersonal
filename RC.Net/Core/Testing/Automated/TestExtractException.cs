...
namespace Extract.Test
{
    ...
    public class TestExtractException
    {
        /// <summary>
        ...
        public static void InnerExceptionFromStringizedException()
        {
            ...
            // Create COMUCLIDException to generate stringized exception.
            COMUCLIDException cex = new COMUCLIDException();
            cex.CreateFromString("ELI00000", "Fake inner exception!");

...
SET Options=--where:'cat!=Interactive and cat!=Broken and cat!=Automated_ADMIN and cat!=OfficeRequired' --dispose-runners --result='%OutputFile%.xml' --result='%OutputFile%.htm;transform=%Transform%'

...
SET Options=--where:'cat!=Interactive and cat!=Broken and cat!=OfficeRequired' --dispose-runners --result='%OutputFile%.xml' --result='%OutputFile%.htm;transform=%Transform%' --agents=1 --workers=1

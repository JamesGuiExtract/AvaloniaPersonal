...
.\nunit3-console.exe (ls -r C:\Program Files (x86)\Extract Systems\CommonComponents\*.Test.dll | % FullName | sort-object -Unique)(ls -r *\bin\Debug\*.Tests.dll | % FullName | sort-object -Unique) --where:cat!=Interactive

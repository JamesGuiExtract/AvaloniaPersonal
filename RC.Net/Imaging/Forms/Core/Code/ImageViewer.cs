...
namespace Extract.Imaging.Forms
{
    ...
    public sealed partial class ImageViewer : RasterImageViewer
    {
        ...
        /// <summary>
        /// Indicates whether the image viewer is currently painting to an external graphics object.
        /// </summary>
        ...
        protected override void OnPostImagePaint(PaintEventArgs e)
        {
            try
            {
                ...
                using (Region clip = new Region(PhysicalViewRectangle))
                {
        ...
        protected override void OnInvalidated(InvalidateEventArgs e)
        {
            try
            {
                // Don't invalidate if currently painting to an external graphics object; the
                // changes that trigger an invalidate are not permanent and allowing them to trigger
                // an invalidate can cause an endless message loop in the case of the magnifier
                // window.

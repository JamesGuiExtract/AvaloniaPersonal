...
{
    /// <summary>
    /// Represents a <see cref="ImageViewerCommandToolStripMenuItem"/> that activates the first
    /// page command.
    /// </summary>
    [ToolboxBitmap(typeof(FirstPageToolStripMenuItem),
       ToolStripButtonConstants._FIRST_PAGE_BUTTON_IMAGE_SMALL)]
    public partial class FirstPageToolStripMenuItem : ImageViewerCommandToolStripMenuItem
    {
        #region FirstPageToolStripMenuItem Constructors

        /// <summary>
        /// Initializes a new <see cref="FirstPageToolStripMenuItem"/> class.
        /// </summary>
        // Don't fight with auto-generated code.
        [SuppressMessage("Microsoft.Performance", "CA1805:DoNotInitializeUnnecessarily")]        
        public FirstPageToolStripMenuItem()
            : base(ToolStripButtonConstants._FIRST_PAGE_MENU_ITEM_TEXT,
            ToolStripButtonConstants._FIRST_PAGE_BUTTON_IMAGE_SMALL,
            typeof(FirstPageToolStripMenuItem))
        {
            InitializeComponent();
        }
        ...
        #region FirstPageToolStripMenuItem Overrides
        ...
        #region FirstPageToolStripMenuItem Events
        ...
        protected override void OnClick(EventArgs e)
        {
            ...
            {
                ExtractException ee = ExtractException.AsExtractException("ELI21402", ex);
        ...
        #region FirstPageToolStripMenuItem Event Handlers
        ...
        private void HandlePageChanged(object sender, PageChangedEventArgs e)
        {
            ...
            {
                ExtractException ee = ExtractException.AsExtractException("ELI21829", ex);
                ee.AddDebugData("Event data", e, false);
                ee.Display();
            }
        }

        #endregion FirstPageToolStripMenuItem Event Handlers

        #region IImageViewerControl Members

        /// <summary>
        /// Gets or sets the image viewer to which the <see cref="FirstPageToolStripMenuItem"/> 
        /// is connected.
        /// </summary>
        /// <value>The image viewer to which the <see cref="FirstPageToolStripMenuItem"/> is 
        /// connected. <see langword="null"/> if connection should be disconnected.</value>
        /// <returns>The image viewer to which the <see cref="FirstPageToolStripMenuItem"/> is 
        ...
        public override ImageViewer ImageViewer
        {
            ...
            set
            {
                ...
                {
                    ExtractException ee = new ExtractException("ELI21830",

namespace Extract.UtilityApplications.Services
{
    partial class ProjectInstaller
    {
        ...
        private void InitializeComponent()
        {
            ...
            // _serviceInstaller
            // 
            this._serviceInstaller.Description = "Facilitates communication between Extract Systems applications.";
            this._serviceInstaller.DisplayName = "Extract Systems IPC Service";
            this._serviceInstaller.ServiceName = "ESIPCService";
            // 
            // ProjectInstaller
            // 

...
namespace Extract.Demo_Pagination
{
    ...
    /// </summary>
    internal partial class ReferralPanel : SectionPanel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferralPanel"/> class.
        /// </summary>
        ...
        public override void LoadData(Demo_PaginationDocumentData data)
        {
            try
            {
                if (data != null)
                {
                    _referringProviderFirstTextBox.Text = data.ReferralFirst;
                    _referringProviderMiddleTextBox.Text = data.ReferralMiddle;
                    _referringProviderLastTextBox.Text = data.ReferralLast;
                    _referringProviderAddressTextBox.Text = data.ReferralAddress;
                }
            }
            catch (Exception ex)
            {
                throw ex.AsExtract("ELI41397");
            }
        }
        ...
        public override bool SaveData(Demo_PaginationDocumentData data, bool validateData)
        {
            try
            {
                if (data != null)
                {
                    data.ReferralFirst = _referringProviderFirstTextBox.Text;
                    data.ReferralMiddle = _referringProviderMiddleTextBox.Text;
                    data.ReferralLast = _referringProviderLastTextBox.Text;
                    data.ReferralAddress = _referringProviderAddressTextBox.Text;
                }

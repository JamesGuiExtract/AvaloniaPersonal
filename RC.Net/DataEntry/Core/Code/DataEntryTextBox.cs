        ...
        public MultipleMatchSelectionMode MultipleMatchSelectionMode
        {
            ...
            set
            {
                try
                {
                    ...
                    {
                        ExtractException.Assert("ELI37370",
                            "Invalid MultipleMatchSelectionMode for a text box.",

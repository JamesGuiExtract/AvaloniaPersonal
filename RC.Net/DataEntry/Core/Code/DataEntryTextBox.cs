    ...
    public partial class DataEntryTextBox : TextBox, IDataEntryControl, IRequiresErrorProvider
    {
        ...
        public DataEntryTextBox()
        {
            try
            {
                ...
                _licenseCache.Validate("ELI23689");
        ...
        /// the <see cref="DataEntryTextBox"/> must match prior to being saved. 
        /// <para><b>Requirements</b></para>
        /// Cannot be specified at the same time <see cref="ValidationPattern"/> is specified.
        /// <para><b>Note</b></para>
        /// If the <see cref="DataEntryTextBox"/>'s value matches a value in the supplied list
        ...
        public string ValidationListFileName
        {
            get
            {
                ...
                {
                    throw ExtractException.AsExtractException("ELI24202", ex);
                }
            }
            ...
            set
            {
                try
                {
                    ...
                    // Add the validation list items as auto-complete values
                    UpdateAutoCompleteValues();
                }
                catch (Exception ex)
                {
                    throw ExtractException.AsExtractException("ELI24229", ex);
                }
            }
        }
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            try
            {
                ...
                // If the delete key is pressed while all text is selected, delete spatial info.
                     ...
                     _attribute != null && base.SelectionLength == base.Text.Length)
                {
                ...
                if (e.KeyCode == Keys.Return && base.AutoCompleteCustomSource != null &&
                    base.AutoCompleteCustomSource.Count > 0 && base.TextLength > 1 && 
                    base.SelectionLength == base.TextLength && this.Text[0] == ' ')
                {
        ...
        public override string Text
        {
            ...
            set
            {
                try
                {
                    ...
                    else if (!_removeNewLineChars && !this.Multiline)
                    {
        ...
        protected override void OnPreviewKeyDown(PreviewKeyDownEventArgs e)
        {
            try
            {
                ...
                if ((e.KeyCode == Keys.Up || e.KeyCode == Keys.Down) &&
                    SelectionStart == Text.Length && !NativeMethods.IsAutoCompleteDisplayed())
                {
        ...
        /// otherwise.</returns>
        bool Validate(bool correctValue)
        {
        ...
        /// <param name="sender">The object that sent the event.</param>
        /// <param name="e">An <see cref="EventArgs"/> that contains the event data.</param>
        void HandleValidationListChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            // If validation list values have been supplied, use them as the auto-complete
            // values.

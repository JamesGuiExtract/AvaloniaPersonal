...
Private m_pPhoneFinder As UCLIDINPUTFINDERSLib.IRegExprFinder
...
errHandler:
    ...
    pEx.CreateFromString "19002", Err.Description
...
Private Sub Command2_Click()
    ...
    ' Create a Highlighted Text Input Receiver
    Dim pHTIR As UCLID_HIGHLIGHTEDTEXTIRLib.IHighlightedTextWindow
    Set pHTIR = New HighlightedTextWindow
    
    ' Apply the phone number Input Finder
    pHTIR.AddInputFinder "Phone Number", m_pPhoneFinder
    
    ' Connect the input receiver to the Input Manager
    m_pFunnel.ConnectInputReceiver pHTIR
    Exit Sub
    
errHandler:
    ' Create a COMUCLIDException object
    Dim pEx As New COMUCLIDException
    pEx.CreateFromString "19003", Err.Description
...
errHandler:
    ' Create a COMUCLIDException object
    Dim pEx As New COMUCLIDException
    pEx.CreateFromString "19000", Err.Description
...
errHandler:
    ' Create a COMUCLIDException object
    Dim pEx As New COMUCLIDException
    pEx.CreateFromString "19001", Err.Description
...
errHandler:
    ' Create a COMUCLIDException object
    Dim pEx As New COMUCLIDException
    pEx.CreateFromString "19004", Err.Description

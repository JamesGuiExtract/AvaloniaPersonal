...
long CInputReceiver::GetParentWndHandle()
{
	long result;
...
void CInputReceiver::SetParentWndHandle(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL CInputReceiver::GetUsesOCR()
{
	BOOL result;
...
void CInputReceiver::SetOCRFilter(LPDISPATCH pFilter)
{
	static BYTE parms[] =
		VTS_DISPATCH;
...
void CInputReceiver::SetOCREngine(LPDISPATCH pEngine)
{
	static BYTE parms[] =
		VTS_DISPATCH;

// AngleInputValidator.h : Declaration of the CAngleInputValidator
...
class ATL_NO_VTABLE CAngleInputValidator : 
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CAngleInputValidator, &CLSID_AngleInputValidator>,
...
DECLARE_REGISTRY_RESOURCEID(IDR_ANGLEINPUTVALIDATOR)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CAngleInputValidator)

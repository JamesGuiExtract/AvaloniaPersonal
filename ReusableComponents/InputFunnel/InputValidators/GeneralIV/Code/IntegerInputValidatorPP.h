// IntegerInputValidatorPP.h : Declaration of the CIntegerInputValidatorPP

#pragma once

#include "resource.h"       // main symbols

EXTERN_C const CLSID CLSID_IntegerInputValidatorPP;

/////////////////////////////////////////////////////////////////////////////
// CIntegerInputValidatorPP
class ATL_NO_VTABLE CIntegerInputValidatorPP :
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CIntegerInputValidatorPP, &CLSID_IntegerInputValidatorPP>,
	public IPropertyPageImpl<CIntegerInputValidatorPP>,
	public CDialogImpl<CIntegerInputValidatorPP>,
	public IDispatchImpl<ILicensedComponent, &IID_ILicensedComponent, &LIBID_UCLID_COMLMLib>
{
public:
	CIntegerInputValidatorPP();

	enum {IDD = IDD_INTEGERINPUTVALIDATORPP};

DECLARE_REGISTRY_RESOURCEID(IDR_INTEGERINPUTVALIDATORPP)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CIntegerInputValidatorPP) 
	COM_INTERFACE_ENTRY(IPropertyPage)
	COM_INTERFACE_ENTRY(IDispatch)
	COM_INTERFACE_ENTRY(ILicensedComponent)
END_COM_MAP()

BEGIN_MSG_MAP(CIntegerInputValidatorPP)
	CHAIN_MSG_MAP(IPropertyPageImpl<CIntegerInputValidatorPP>)

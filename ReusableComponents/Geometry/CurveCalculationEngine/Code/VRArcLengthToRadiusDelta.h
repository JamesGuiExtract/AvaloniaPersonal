...
// ALL RIGHTS RESERVED.
//
// FILE		:	VRArcLengthToRadiusDelta.h
//
// PURPOSE	:	This is an header file for VRArcLengthToRadiusDelta class
...
//				pArcLength,pArcRadius and pArcDelta
//
// NOTES	:	Nothing
//
...
//==================================================================================================
//
// CLASS		:	VRArcLengthToRadiusDelta
//
...
//
//==================================================================================================
class VRArcLengthToRadiusDelta:public CurveVariableRelationship
{
//Operations
public:
	VRArcLengthToRadiusDelta(CurveVariable *pArcLength,CurveVariable *pArcRadius, CurveVariable *pArcDelta);
	//----------------------------------------------------------------------------------------------

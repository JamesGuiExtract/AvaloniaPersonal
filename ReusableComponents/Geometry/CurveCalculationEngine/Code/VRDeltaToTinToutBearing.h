...
// ALL RIGHTS RESERVED.
//
// FILE		:	VRDeltaToTinToutBearing.h
//
// PURPOSE	:	This is an header file for VRDeltaToTinToutBearing class
...
//				pArcDelta,pArcTangentInBearing,pArcTangentOutBearing and pArcConcaveLeft
//
// NOTES	:	Nothing
//
...
//
//==================================================================================================
class VRDeltaToTinToutBearing:public CurveVariableRelationship
{
//Operations
public:
	VRDeltaToTinToutBearing(CurveVariable *pArcConcaveLeft,CurveVariable *pArcDelta,CurveVariable *pArcTangentInBearing, CurveVariable *pArcTangentOutBearing);
	//----------------------------------------------------------------------------------------------

...
// ALL RIGHTS RESERVED.
//
// FILE		:	VRMiddleOrdinateToRadiusDelta.h
//
// PURPOSE	:	This is an header file for VRMiddleOrdinateToRadiusDelta class
...
//				pArcMiddleOrdinate,pArcRadius and pArcDelta
//
// NOTES	:	Nothing
//
...
//==================================================================================================
//
// CLASS		:	VRMiddleOrdinateToRadiusDelta
//
...
//
//==================================================================================================
class VRMiddleOrdinateToRadiusDelta:public CurveVariableRelationship
{
//Operations
public:
	VRMiddleOrdinateToRadiusDelta(CurveVariable *pArcMiddleOrdinate,CurveVariable *pArcRadius, CurveVariable *pArcDelta);
	//----------------------------------------------------------------------------------------------

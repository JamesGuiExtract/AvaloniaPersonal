...
// ALL RIGHTS RESERVED.
//
// FILE		:	VRStartAngleToTinBearing.h
//
// PURPOSE	:	This is an header file for VRStartAngleToTinBearing class
...
//				pArcStartAngle and pArcTangentInBearing
//
// NOTES	:	Nothing
//
...
//==================================================================================================
//
// CLASS		:	VRStartAngleToTinBearing
//
...
//
//==================================================================================================
class VRStartAngleToTinBearing:public CurveVariableRelationship
{
//Operations
public:
	VRStartAngleToTinBearing(CurveVariable *pArcConcaveLeft,CurveVariable *pArcStartAngle, CurveVariable *pArcTangentInBearing);
	//----------------------------------------------------------------------------------------------
...
private:
	...
	//Arc Start Angle
	CurveVariable *m_pArcStartAngle;

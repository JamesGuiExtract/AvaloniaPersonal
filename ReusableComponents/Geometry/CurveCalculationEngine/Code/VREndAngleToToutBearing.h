...
// ALL RIGHTS RESERVED.
//
// FILE		:	VREndAngleToToutBearing.h
//
// PURPOSE	:	This is an header file for VREndAngleToToutBearing class
...
//				pArcEndAngle and pArcTangentOutBearing
//
// NOTES	:	Nothing
//
...
//
//==================================================================================================
class VREndAngleToToutBearing : public CurveVariableRelationship
{
//Operations
public:
	VREndAngleToToutBearing(CurveVariable *pArcConcaveLeft,CurveVariable *pArcEndAngle, CurveVariable *pArcTangentOutBearing);
	//----------------------------------------------------------------------------------------------

...
// ALL RIGHTS RESERVED.
//
// FILE		:	VRCenterToStartingPointRadiusRin.h
//
// PURPOSE	:	This is an header file for VRCenterToStartingPointRadiusRin class
...
//				pArcCenter,pArcStartingPoint,pArcRadius and pArcRadialInBearing
//
// NOTES	:	Nothing
//
...
//==================================================================================================
//
// CLASS		:	VRCenterToStartingPointRadiusRin
//
...
//
//==================================================================================================
class VRCenterToStartingPointRadiusRin:public CurveVariableRelationship
{
//Operations
public:
	VRCenterToStartingPointRadiusRin(CurveVariable *pArcCenter,CurveVariable *pArcStartingPoint, CurveVariable *pArcRadius,CurveVariable *pArcRadialInBearing);
	//----------------------------------------------------------------------------------------------

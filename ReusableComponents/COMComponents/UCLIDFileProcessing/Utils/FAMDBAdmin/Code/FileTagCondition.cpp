...
// Public methods
//--------------------------------------------------------------------------------------------------
bool FileTagCondition::configure(const IFileProcessingDBPtr& ipFAMDB, const string& strQueryHeader)
{
...
//--------------------------------------------------------------------------------------------------
string FileTagCondition::buildQuery(const IFileProcessingDBPtr& ipFAMDB, const string& strSelect)
{

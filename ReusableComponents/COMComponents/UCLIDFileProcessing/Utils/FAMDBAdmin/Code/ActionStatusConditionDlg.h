...
{
public:
	ActionStatusConditionDlg(const IFileProcessingDBPtr& ipFAMDB);
	ActionStatusConditionDlg(const IFileProcessingDBPtr& ipFAMDB, const ActionStatusCondition& settings);

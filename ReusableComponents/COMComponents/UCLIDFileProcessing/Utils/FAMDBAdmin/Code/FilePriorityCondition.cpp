...
// Public methods
//--------------------------------------------------------------------------------------------------
bool FilePriorityCondition::configure(const IFileProcessingDBPtr& ipFAMDB,
...
//--------------------------------------------------------------------------------------------------
string FilePriorityCondition::buildQuery(const IFileProcessingDBPtr& ipFAMDB, const string& strSelect)
{

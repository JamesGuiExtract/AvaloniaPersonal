...
// IFAMCondition
//-------------------------------------------------------------------------------------------------
STDMETHODIMP CMultiFAMConditionNONE::raw_FileMatchesFAMCondition(BSTR bstrFile, IFileProcessingDB *pFPDB, BSTR bstrAction, 
														 IFAMTagManager *pFAMTM, VARIANT_BOOL* pRetVal)
{
	...
	try
	{
		...
		if (m_ipGenericMultiFAMCondition == NULL)
		{
			...
			ASSERT_RESOURCE_ALLOCATION("ELI13860", m_ipGenericMultiFAMCondition != NULL);
		}
		...
		*pRetVal = m_ipGenericMultiFAMCondition->FileMatchesFAMCondition(m_ipMultiFAMConditions, 
			EXTRACT_FAMCONDITIONSLib::kNONEOperator, bstrFile, pFPDB, bstrAction, pFAMTM);
	}
...
STDMETHODIMP CMultiFAMConditionNONE::Load(IStream *pStream)
{
	...
	try
	{
		...
		ASSERT_RESOURCE_ALLOCATION("ELI13905", m_ipMultiFAMConditions != NULL);
...
STDMETHODIMP CMultiFAMConditionNONE::raw_Clone(IUnknown **pObject)
{
	...
	try
	{
		...
		ASSERT_RESOURCE_ALLOCATION("ELI13914", ipObjCopy != NULL);
...
STDMETHODIMP CMultiFAMConditionNONE::get_ObjectsVector(IIUnknownVector* *pVal)
{
	...
	try
	{
		...
		if (m_ipMultiFAMConditions == NULL)
		{
			...
			ASSERT_RESOURCE_ALLOCATION("ELI13918", m_ipMultiFAMConditions != NULL);
		}
...
STDMETHODIMP CMultiFAMConditionNONE::put_ObjectsVector(IIUnknownVector *newVal)
{
	...
	try
	{
		...
		ASSERT_RESOURCE_ALLOCATION("ELI13920", ipMultiFAMConditions != NULL);
...
STDMETHODIMP CMultiFAMConditionNONE::raw_GetComponentDescription(BSTR * pstrComponentDescription)
{
	...
	try
	{
		ASSERT_ARGUMENT("ELI19640", pstrComponentDescription != NULL)

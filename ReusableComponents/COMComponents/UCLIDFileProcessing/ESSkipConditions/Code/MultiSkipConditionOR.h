// MultiFAMConditionOR.h : Declaration of the CMultiFAMConditionOR
...
class ATL_NO_VTABLE CMultiFAMConditionOR : 
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CMultiFAMConditionOR, &CLSID_MultiFAMConditionOR>,
	...
	public ISpecifyPropertyPagesImpl<CMultiFAMConditionOR>
{
public:
	CMultiFAMConditionOR();
	~CMultiFAMConditionOR();

DECLARE_REGISTRY_RESOURCEID(IDR_MULTIFAMCONDITIONOR)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CMultiFAMConditionOR)
...
BEGIN_PROP_MAP(CMultiFAMConditionOR)
	PROP_PAGE(CLSID_MultipleObjSelectorPP)
END_PROP_MAP()

BEGIN_CATEGORY_MAP(CMultiFAMConditionOR)
...
private:
	...
	// Gets the GenericMultiFAMCondition and creates it if it has not been created

// MultiFAMConditionAND.h : Declaration of the CMultiFAMConditionAND
...
class ATL_NO_VTABLE CMultiFAMConditionAND : 
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CMultiFAMConditionAND, &CLSID_MultiFAMConditionAND>,
...
DECLARE_REGISTRY_RESOURCEID(IDR_MULTIFAMCONDITIONAND)
...
BEGIN_PROP_MAP(CMultiFAMConditionAND)
	PROP_PAGE(CLSID_MultipleObjSelectorPP)
END_PROP_MAP()

BEGIN_CATEGORY_MAP(CMultiFAMConditionAND)

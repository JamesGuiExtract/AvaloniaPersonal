// MultiFAMConditionEXACTONE.h : Declaration of the CMultiFAMConditionEXACTONE
...
class ATL_NO_VTABLE CMultiFAMConditionEXACTONE : 
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CMultiFAMConditionEXACTONE, &CLSID_MultiFAMConditionEXACTONE>,
	...
	public ISpecifyPropertyPagesImpl<CMultiFAMConditionEXACTONE>
{
public:
	CMultiFAMConditionEXACTONE();
	~CMultiFAMConditionEXACTONE();

DECLARE_REGISTRY_RESOURCEID(IDR_MULTIFAMCONDITIONEXACTONE)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CMultiFAMConditionEXACTONE)
...
BEGIN_PROP_MAP(CMultiFAMConditionEXACTONE)
	PROP_PAGE(CLSID_MultipleObjSelectorPP)
END_PROP_MAP()

BEGIN_CATEGORY_MAP(CMultiFAMConditionEXACTONE)

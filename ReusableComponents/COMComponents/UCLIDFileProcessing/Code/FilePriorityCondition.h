...
public:
	...
	void setPriority(UCLID_FILEPROCESSINGLib::EFilePriority ePriority);
	UCLID_FILEPROCESSINGLib::EFilePriority getPriority() { return m_ePriority; }
...
private:
	...
	UCLID_FILEPROCESSINGLib::EFilePriority m_ePriority; // The priority to select

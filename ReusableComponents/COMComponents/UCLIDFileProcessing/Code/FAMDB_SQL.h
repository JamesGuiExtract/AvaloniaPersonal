...
static const string gstrCREATE_ATTRIBUTE_INSTANCE_TYPE = 
...
static const string gstrCREATE_ATTRIBUTE_TABLE_128 = 
	...
	"[AttributeTypeID] [int] NULL, "				// FK, AttributeType.ID
...
static const string gstrADD_ATTRIBUTE_SET_FOR_FILEID_FK = 
...
static const string gstrADD_ATTRIBUTE_INSTANCE_TYPE_ATTRIBUTEID = 
...
static const string gstrADD_ATTRIBUTE_INSTANCE_TYPE_ATTRIBUTETYPEID = 
	"ALTER TABLE [AttributeInstanceType] "
...
static const string gstrADD_ATTRIBUTE_ATTRIBUTE_SET_FILE_FILEID_FK = 
...
static const string gstrADD_ATTRIBUTE_ATTRIBUTE_NAMEID_FK = 
	"ALTER TABLE [Attribute] "
...
// No longer in database, was defined in 128, dropped in 129 when the table was modified.
static const string gstrADD_ATTRIBUTE_ATTRIBUTE_TYPEID_FK = 
	"ALTER TABLE [Attribute] "
	"WITH CHECK ADD CONSTRAINT [FK_Attribute_AttributeTypeID] FOREIGN KEY([AttributeTypeID]) "
	"REFERENCES [AttributeType] ([ID]) "
	"ON UPDATE CASCADE "
	"ON DELETE CASCADE";

static const string gstrADD_ATTRIBUTE_PARENT_ATTRIBUTEID_FK = 
	"ALTER TABLE [Attribute] "
...
static const string gstrADD_RASTER_ZONE_ATTRIBUTEID_FK = 

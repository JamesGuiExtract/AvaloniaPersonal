...
"			), Ranked AS \r\n"
"			( \r\n"
"				SELECT ActionID, FileID, ActionStatus, Priority, Invisible, \r\n"
"				RANK() OVER \r\n"
...
"			,N''@BatchSize INT, @StatusToQueue NVARCHAR(1), @SkippedForUser NVARCHAR(50), @UserID INT, @LimitToUserQueue BIT, @IncludeFilesQueuedForOthers BIT, @FAMSessionID INT, @WorkflowID INT, @ActionName NVARCHAR(50)'' \r\n"
"			,@BatchSize  \r\n"
"			,@StatusToQueue  \r\n"
"			,@SkippedForUser  \r\n"
"			,@UserID  \r\n"

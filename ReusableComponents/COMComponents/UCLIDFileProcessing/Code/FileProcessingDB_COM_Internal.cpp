...
const long CFileProcessingDB::ms_lFAMDBSchemaVersion = 224;
...
//-------------------------------------------------------------------------------------------------
int UpdateToSchemaVersion207(_ConnectionPtr ipConnection, long* pnNumSteps,
	IProgressStatusPtr ipProgressStatus)
{
	try
	{
		int nNewSchemaVersion = 207;
...
//-------------------------------------------------------------------------------------------------
int UpdateToSchemaVersion212(_ConnectionPtr ipConnection, long* pnNumSteps,
	IProgressStatusPtr ipProgressStatus)
{
	try
	{
		int nNewSchemaVersion = 212;
...
//-------------------------------------------------------------------------------------------------
int UpdateToSchemaVersion214(_ConnectionPtr ipConnection, long* pnNumSteps,
	IProgressStatusPtr ipProgressStatus)
{
	try
	{
		int nNewSchemaVersion = 214;
	...
	IProgressStatusPtr ipProgressStatus)
{
	try
	{
		...
		JsonSchemaUpdates::CopyToWebApiConfiguration(ipConnection);
...
//-------------------------------------------------------------------------------------------------
int UpdateToSchemaVersion220(_ConnectionPtr ipConnection, long* pnNumSteps,
	IProgressStatusPtr ipProgressStatus)
{
	try
	{
		int nNewSchemaVersion = 220;
		...
		vecQueries.push_back(gstrINSERT_TASKCLASS_COMBINE_PAGES);
		vecQueries.push_back(buildUpdateSchemaVersionQuery(nNewSchemaVersion));
	...
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI53946");
}
//-------------------------------------------------------------------------------------------------
int UpdateToSchemaVersion221(_ConnectionPtr ipConnection, long* pnNumSteps,
	IProgressStatusPtr ipProgressStatus)
{
	try
	{
		int nNewSchemaVersion = 221;
		...
		vecQueries.push_back(gstrUPDATE_TASKCLASS_COMBINE_PAGES);
		vecQueries.push_back(buildUpdateSchemaVersionQuery(nNewSchemaVersion));
	...
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI53964");
}
//-------------------------------------------------------------------------------------------------
int UpdateToSchemaVersion222(_ConnectionPtr ipConnection, long* pnNumSteps,
	IProgressStatusPtr ipProgressStatus)
{
	try
	{
		int nNewSchemaVersion = 222;
		...
		vecQueries.push_back(gstrDROP_WORK_ITEM_INDEXES_RENAME_FAMSESSION_MANUAL_INDEXES);
...
//-------------------------------------------------------------------------------------------------
int UpdateToSchemaVersion224(_ConnectionPtr ipConnection, long* pnNumSteps,
	IProgressStatusPtr ipProgressStatus)
{
	try
	{
		int nNewSchemaVersion = 224;
		...
		vecQueries.push_back(gstrCREATE_FILE_TASK_SESSION_TASK_DATE_SESSION_INDEX);
	...
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI54078");
}
	...
	try
	{
		try
		{
			...
			switch (nSchemaVersion)
			{
				...
				case 223:	vecUpdateFuncs.push_back(&UpdateToSchemaVersion224);
				case 224:
					break;

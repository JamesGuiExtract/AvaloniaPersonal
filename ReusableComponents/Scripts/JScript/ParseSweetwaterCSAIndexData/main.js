//--------------------------------------------------------------------------------------------------
// Script commands specific for ParseSweetwaterCSAIndexData
//--------------------------------------------------------------------------------------------------
//
//--------------------------------------------------------------------------------------------------
// Script Description
...
//  K:\Common\Engineering\Sample Files\CSA\WY - Sweetwater\Set001\IndexData\IndexLegals.txt
//  K:\Common\Engineering\Sample Files\CSA\WY - Sweetwater\Set001\IndexData\IndexParties.txt
//  K:\Common\Engineering\Sample Files\CSA\WY - Sweetwater\Set002\IndexData\IndexRelatedDocs.txt
//--------------------------------------------------------------------------------------------------
...
function main(args) {
    ...
    function copyImages(imagesToDocTypes) {
        for (iname in imagesToDocTypes) {
            ...
            try {
                ...
                handleScriptError("ParseSweetwaterCSAIndexData_1", "Unable to create folder!", err, "FolderName", newdir);
            }
            ...
            try {
                ...
                handleScriptError("ParseSweetwaterCSAIndexData_2", "Unable to copy file!", err, "FileName", iname, "Destination", newdir);
            }
        }
    }
    ...
    function appendText(fname, text) {
        ...
        try {
            ...
            handleScriptError("ParseSweetwaterCSAIndexData_3", "Unable to open output file!", err, "FileName", fname);
        }
        // Write to the file
        f.Write(text);
        f.Close();
    ...
    function getImageName(partialName) {
        ...
        if (file == undefined) {
            handleScriptError("ParseSweetwaterCSAIndexData_4", "Can't figure out file name!",
    ...
    function makeEAVS_DOCS(fields) {
        ...
        try {
            ...
            handleScriptError("ParseSweetwaterCSAIndexData_6", "Error!", err, "Index Data Line", fields);
        }
        ...
        try {
            ...
            handleScriptError("ParseSweetwaterCSAIndexData_7", "Error!", err, "Index Data Line", fields);
        }
    }
    ...
    function makeEAVS_REFERENCE(fields) {
        ...
        try {
            val = fields[1];
            writeAttr(fname, "DocNumber", val, "", ".");
        }
        catch(err) {
            handleScriptError("ParseSweetwaterCSAIndexData_8", "Error!", err, "Index Data Line", fields);
        }
        try {
            val = fields[2];
            ...
            handleScriptError("ParseSweetwaterCSAIndexData_9", "Error!", err, "Index Data Line", fields);
        }
        try {
            val = fields[3];
            ...
            handleScriptError("ParseSweetwaterCSAIndexData_10", "Error!", err, "Index Data Line", fields);
        }
    }
    ...
    function makeEAVS_PARTIES(fields) {
        ...
        try {
            ...
            handleScriptError("ParseSweetwaterCSAIndexData_11", "Error!", err, "Index Data Line", fields);
        }
    }
    ...
    function makeEAVS_LEGAL(fields) {
        ...
        try {
            ...
            handleScriptError("ParseSweetwaterCSAIndexData_12", "Error!", err, "Index Data Line", fields);
        }
        try {
            val = fields[2];
            if (val != "") {

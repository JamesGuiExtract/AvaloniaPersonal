...
{
    { RGB(0xFF, 0x00, 0x00),    _T("AutoCAD Red")       },
    { RGB(0xFF, 0xFF, 0x00),    _T("AutoCAD Yellow")    },
    { RGB(0x00, 0xFF, 0x00),    _T("AutoCAD Green")     },
    { RGB(0x00, 0xFF, 0xFF),    _T("AutoCAD Cyan")      },
    { RGB(0x00, 0x00, 0xFF),    _T("AutoCAD Blue")      },
    { RGB(0xFF, 0x00, 0xFF),    _T("AutoCAD Magenta")   },
    { RGB(0x80, 0x80, 0x80),    _T("AutoCAD Color 8")   },
    { RGB(0xC0, 0xC0, 0xC0),    _T("AutoCAD Color 9")   },

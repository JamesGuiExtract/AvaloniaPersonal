...
class CCheckList : public CWnd
{
	...
	// misc items
	bool bReadOnly; // if this is true, then all mouse down events to change the
					// state of the check box are ignored.

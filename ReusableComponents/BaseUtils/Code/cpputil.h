...
//
// Arguments:
// const std::string& text - the source text to search
// const std::string& contains - the substring or char[] to match
//
// returns: true on match, false if no match
//
enum ContainsMatchType
{
    MatchSubstring,
    MatchSingleChar
};
...
namespace Util
{
  ...
  // Util::Format() is a set of templated overloaded functions that take a format specifier
  // string constant (exactly like printf or sprintf does), and a set of 1..N arguments for
  // the specifier string. Format can be thought of as a sprintf() that returns a std::string.
  template <typename ArgT1>
  std::string Format( const char* formatString, const ArgT1 arg1 )
  {
	  std::vector<char> buffer( Internal::Size, '\0' );
	  _snprintf_s( &buffer[0], Internal::Size, _TRUNCATE, formatString, arg1 );
	  return std::string( &buffer[0] );
  }

  template <typename ArgT1, typename ArgT2>
  std::string Format( const char* formatString, const ArgT1 arg1, const ArgT2 arg2 )
  {
	  std::vector<char> buffer( Internal::Size, '\0' );
	  _snprintf_s( &buffer[0], Internal::Size, _TRUNCATE, formatString, arg1, arg2 );
	  return std::string( &buffer[0] );
  }

  template <typename ArgT1, typename ArgT2, typename ArgT3>
  std::string Format( const char* formatString, const ArgT1 arg1, const ArgT2 arg2, const ArgT3 arg3 )
  {
	  std::vector<char> buffer( Internal::Size, '\0' );
	  _snprintf_s( &buffer[0], Internal::Size, _TRUNCATE, formatString, arg1, arg2, arg3 );
	  return std::string( &buffer[0] );
  }

  template <typename ArgT1, typename ArgT2, typename ArgT3, typename ArgT4>
  std::string Format( const char* formatString, const ArgT1 arg1, const ArgT2 arg2, const ArgT3 arg3, const ArgT4 arg4 )
  {
	  std::vector<char> buffer( Internal::Size, '\0' );
	  _snprintf_s( &buffer[0], Internal::Size, _TRUNCATE, formatString, arg1, arg2, arg3, arg4 );
	  return std::string( &buffer[0] );
  }
  ...
  {
	  std::vector<char> buffer( Internal::Size, '\0' );
	  _snprintf_s( &buffer[0], Internal::Size, _TRUNCATE, formatString, arg1, arg2, arg3, arg4, arg5 );
	  return std::string( &buffer[0] );
  }
  ...
  {
	  std::vector<char> buffer( Internal::Size, '\0' );
	  _snprintf_s( &buffer[0], Internal::Size, _TRUNCATE, formatString, arg1, arg2, arg3, arg4, arg5, arg6 );
	  return std::string( &buffer[0] );
  }
  ...
  {
	  std::vector<char> buffer( Internal::Size, '\0' );
	  _snprintf_s( &buffer[0], Internal::Size, _TRUNCATE, formatString, arg1, arg2, arg3, arg4, arg5, arg6, arg7 );
	  return std::string( &buffer[0] );
  }
  ...
  {
	  std::vector<char> buffer( Internal::Size, '\0' );
	  _snprintf_s( &buffer[0], Internal::Size, _TRUNCATE, formatString, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8 );
	  return std::string( &buffer[0] );
  }

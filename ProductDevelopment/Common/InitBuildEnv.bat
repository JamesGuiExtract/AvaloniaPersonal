...
SET PATH=%PATH%;%DevEnvDir%;%VCPP_DIR%\BIN;%VS_COMMON%\Tools;%VS_COMMON%\Tools\bin;C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319;%VCPP_DIR%\VCPackages;C:\Program Files\PreEmptive Solutions\Dotfuscator Professional Edition 4.7;C:\Program Files\Microsoft FxCop 1.36;

...
SET PATH=%windir%;%windir%\System32;I:\Common\Engineering\Tools\Utils;%VAULT_DIR%;%BUILD_VSS_ROOT%\Engineering\ReusableComponents\APIs\Nuance_16\bin;%BUILD_VSS_ROOT%\Engineering\ReusableComponents\APIs\LeadTools_16.5\Bin;%BUILD_VSS_ROOT%\Engineering\ReusableComponents\APIs\RogueWave\bin;%BUILD_VSS_ROOT%\Engineering\ReusableComponents\APIs\SafeNetUltraPro\Bin;%BUILD_VSS_ROOT%\Engineering\ReusableComponents\APIs\Inlite_5_7\bin

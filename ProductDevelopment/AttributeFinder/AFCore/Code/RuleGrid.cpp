...
BEGIN_MESSAGE_MAP(CRuleGrid,CUGCtrl)
	//{{AFX_MSG_MAP(CRuleGrid)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
//--------------------------------------------------------------------------------------------------
// Standard CRuleGrid construction/destruction
//--------------------------------------------------------------------------------------------------
CRuleGrid::CRuleGrid()
: m_lastSelectedRow(-1)
{
	try
	{
		...
		ASSERT_RESOURCE_ALLOCATION("ELI32959", hFont != __nullptr);

		LOGFONT logfont;
		if (GetObject(hFont, sizeof(logfont), &logfont) == 0)
		{
			UCLIDException ue("ELI32960", "Failed to retrieve font info.");
		...
		if (!bFontCreated)
		{
			throw UCLIDException("ELI32961", "Failed to create font.");
		}

		
	}
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI32962");
}
//--------------------------------------------------------------------------------------------------
CRuleGrid::~CRuleGrid()
{
	...
	CATCH_AND_LOG_ALL_EXCEPTIONS("ELI32963");
}
//--------------------------------------------------------------------------------------------------
//	OnSetup
...
void CRuleGrid::OnSetup()
{
	AFX_MANAGE_STATE(AfxGetModuleState());

	try
	{
		CHECK_UG_RETURN_VALUE("ELI32964", SetMultiSelectMode(2));
		CHECK_UG_RETURN_VALUE("ELI32965", SetHighlightRow(TRUE));
		CHECK_UG_RETURN_VALUE("ELI32966", SetSH_Width(0));
		CHECK_UG_RETURN_VALUE("ELI32967", SetNumberCols(3));

		CUGCell cell;
		CHECK_UG_RETURN_VALUE("ELI32968", cell.CopyInfoFrom(m_GI->m_hdgDefaults));
		CHECK_UG_RETURN_VALUE("ELI32969", cell.SetFont(&m_font));

		CHECK_UG_RETURN_VALUE("ELI32970", cell.SetText("On"));
		CHECK_UG_RETURN_VALUE("ELI32971", SetColWidth(0, 25));
		CHECK_UG_RETURN_VALUE("ELI32972", SetCell(0, -1, &cell));

		CHECK_UG_RETURN_VALUE("ELI32973", cell.SetText("IE"));
		CHECK_UG_RETURN_VALUE("ELI32974", SetColWidth(1, 25));
		CHECK_UG_RETURN_VALUE("ELI32975", SetCell(1, -1, &cell));

		CHECK_UG_RETURN_VALUE("ELI32976", cell.SetText("Description"));
		CHECK_UG_RETURN_VALUE("ELI32977", SetColWidth(2, 0));
		CHECK_UG_RETURN_VALUE("ELI32978", SetCell(2, -1, &cell));
	}
	CATCH_AND_DISPLAY_ALL_EXCEPTIONS("ELI32979");
}
//--------------------------------------------------------------------------------------------------
//	OnSheetSetup	
...
//	Return:
//		<none>
void CRuleGrid::OnSheetSetup(int sheetNumber)
{
...
int CRuleGrid::OnCanMove(int oldcol,long oldrow,int newcol,long newrow)
{
...
int CRuleGrid::OnCanViewMove(int oldcol,long oldrow,int newcol,long newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newcol);
...
//	Return:
//		<none>
void CRuleGrid::OnHitBottom(long numrows,long rowspast,long rowsfound)
{
...
//	Return:
//		<none>
void CRuleGrid::OnHitTop(long numrows,long rowspast)
{
	UNREFERENCED_PARAMETER(numrows);
	UNREFERENCED_PARAMETER(rowspast);
}
...
int CRuleGrid::OnCanSizeCol(int col)
{
...
//	Return:
//		<none>
void CRuleGrid::OnColSizing(int col,int *width)
{
	UNREFERENCED_PARAMETER(col);
...
//	Return:
//		<none>
void CRuleGrid::OnColSized(int col,int *width)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(*width);
}
...
//		TRUE - to allow sizing
//		FALSE - to prevent sizing
int CRuleGrid::OnCanSizeRow(long row)
{
...
//	Return:
//		<none>
void CRuleGrid::OnRowSizing(long row,int *height)
{
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CRuleGrid::OnRowSized(long row,int *height)
{
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*height);
}
...
//		TRUE - to allow sizing
//		FALSE - to prevent sizing
int CRuleGrid::OnCanSizeSideHdg()
{
	return FALSE;
}
//--------------------------------------------------------------------------------------------------
...
int CRuleGrid::OnSideHdgSizing(int *width)
{
	UNREFERENCED_PARAMETER(*width);
	return TRUE;
}
...
int CRuleGrid::OnSideHdgSized(int *width)
{
	UNREFERENCED_PARAMETER(*width);
	return TRUE;
}
...
//		TRUE - to accept current new size
//		FALSE - to stop sizing, the size is either too large or too small
int CRuleGrid::OnTopHdgSizing(int *height)
{
	UNREFERENCED_PARAMETER(*height);
	return TRUE;
}
...
//		TRUE - to accept new size
//		FALSE - to revert to old size
int CRuleGrid::OnTopHdgSized(int *height)
{
	UNREFERENCED_PARAMETER(*height);
	return TRUE;
}
...
//	Return:
//		<none>
void CRuleGrid::OnColChange(int oldcol,int newcol)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
}
...
//	Return:
//		<none>
void CRuleGrid::OnRowChange(long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newrow);
}
...
//	Return:
//		<none>
void CRuleGrid::OnCellChange(int oldcol,int newcol,long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
	UNREFERENCED_PARAMETER(oldrow);
...
//	Return:
//		<none>
void CRuleGrid::OnLeftColChange(int oldcol,int newcol)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
}
...
//	Return:
//		<none>
void CRuleGrid::OnTopRowChange(long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newrow);
}
...
//	Return:
//		<none>
void CRuleGrid::OnViewMoved( int nScrolDir, long oldPos, long newPos )
{
...
//	Return:
//		<none>
void CRuleGrid::OnSelectionChanged(int startCol,long startRow,int endCol,long endRow,int blockNum)
{
	...
	GetParent()->PostMessage(WM_RULE_GRID_SELCHANGE, ::GetDlgCtrlID(m_hWnd), (LPARAM)startRow);
}
//--------------------------------------------------------------------------------------------------
//	OnLClicked
...
//	Return:
//		<none>
void CRuleGrid::OnLClicked(int col,long row,int updn,RECT *rect,POINT *point,int processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CRuleGrid::OnRClicked(int col,long row,int updn,RECT *rect,POINT *point,int processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(updn);
	UNREFERENCED_PARAMETER(*rect);
	...
	GetParent()->PostMessage(WM_RULE_GRID_RCLICK, ::GetDlgCtrlID(m_hWnd), row);
}
//--------------------------------------------------------------------------------------------------
//	OnDClicked
...
//	Return:
//		<none>
void CRuleGrid::OnDClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	AFX_MANAGE_STATE(AfxGetModuleState());
	...
	try
	{
		...
		GetParent()->PostMessage(WM_RULE_GRID_DBLCLICK, ::GetDlgCtrlID(m_hWnd),
			MAKELPARAM(row, col));
	}
	CATCH_AND_DISPLAY_ALL_EXCEPTIONS("ELI32980");
}	
//--------------------------------------------------------------------------------------------------
//	OnMouseMove
...
//	Return:
//		<none>
void CRuleGrid::OnMouseMove(int col,long row,POINT *point,UINT nFlags,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void CRuleGrid::OnTH_LClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CRuleGrid::OnTH_RClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CRuleGrid::OnTH_DClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void CRuleGrid::OnSH_LClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CRuleGrid::OnSH_RClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CRuleGrid::OnSH_DClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void CRuleGrid::OnCB_LClicked(int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(updn);
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void CRuleGrid::OnCB_RClicked(int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(updn);
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void CRuleGrid::OnCB_DClicked(RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
	UNREFERENCED_PARAMETER(processed);
...
//	Return:
//		<none>
void CRuleGrid::OnKeyDown(UINT *vcKey,BOOL processed)
{
...
//	Return:
//		<none>
void CRuleGrid::OnKeyUp(UINT *vcKey,BOOL processed)
{
	UNREFERENCED_PARAMETER(*vcKey);
	UNREFERENCED_PARAMETER(processed);
//	GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//	Return:
//		<none>
void CRuleGrid::OnCharDown(UINT *vcKey,BOOL processed)
{
	UNREFERENCED_PARAMETER(*vcKey);
	UNREFERENCED_PARAMETER(processed);
//	GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//	Return:
//		<none>
void CRuleGrid::OnGetCell(int col,long row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CRuleGrid::OnSetCell(int col,long row,CUGCell *cell)
{
	AFX_MANAGE_STATE(AfxGetModuleState());
	...
	try
	{
		...
		if (m_enableUpdate)
		{
			GetParent()->PostMessage(WM_RULE_GRID_CELL_VALUE_CHANGE, ::GetDlgCtrlID(m_hWnd),
				MAKELPARAM(row, col));
		}
	}
	CATCH_AND_DISPLAY_ALL_EXCEPTIONS("ELI32981");
}
//--------------------------------------------------------------------------------------------------
//	OnDataSourceNotify
...
//	Return:
//		<none>
void CRuleGrid::OnDataSourceNotify(int ID,long msg,long param)
{
...
int CRuleGrid::OnCellTypeNotify(long ID,int col,long row,long msg,long param)
{
	UNREFERENCED_PARAMETER(ID);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int CRuleGrid::OnEditStart(int col, long row,CWnd **edit)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int CRuleGrid::OnEditVerify(int col, long row,CWnd *edit,UINT *vcKey)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
...
int CRuleGrid::OnEditFinish(int col, long row,CWnd *edit,LPCTSTR string,BOOL cancelFlag)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
...
int CRuleGrid::OnEditContinue(int oldcol,long oldrow,int* newcol,long* newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(*newcol);
...
//	Return:
//		<none>
void CRuleGrid::OnMenuCommand(int col,long row,int section,int item)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int CRuleGrid::OnMenuStart(int col,long row,int section)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(section);
...
DWORD CRuleGrid::OnGetContextHelpID( int col, long row, int section )
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(section);
...
int CRuleGrid::OnHint(int col,long row,int section,CString *string)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(section);
...
//		TRUE - to show the hint
//		FALSE - to prevent the hint from showing
int CRuleGrid::OnVScrollHint(long row,CString *string)
{
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*string);
	return TRUE;
...
//		TRUE - to show the hint
//		FALSE - to prevent the hint from showing
int CRuleGrid::OnHScrollHint(int col,CString *string)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(*string);
	return TRUE;
...
DROPEFFECT CRuleGrid::OnDragEnter(COleDataObject* pDataObject)
{
...
//		DROPEFFECT_NONE - no drag and drop
//		DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CRuleGrid::OnDragOver(COleDataObject* pDataObject,int col,long row)
{
	UNREFERENCED_PARAMETER(*pDataObject);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//		DROPEFFECT_NONE - no drag and drop
//		DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CRuleGrid::OnDragDrop(COleDataObject* pDataObject,int col,long row)
{
	UNREFERENCED_PARAMETER(*pDataObject);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CRuleGrid::OnScreenDCSetup(CDC *dc,int section)
{
...
int CRuleGrid::OnSortEvaluate(CUGCell *cell1,CUGCell *cell2,int flags)
{
	AFX_MANAGE_STATE(AfxGetModuleState());
	...
	CATCH_AND_DISPLAY_ALL_EXCEPTIONS("ELI32982");
...
//	Return:
//		<none>
void CRuleGrid::OnTabSelected(int ID)
{
	UNREFERENCED_PARAMETER(ID);
}
//--------------------------------------------------------------------------------------------------
...
//	Return:
//		<none>
void CRuleGrid::OnAdjustComponentSizes(RECT *grid,RECT *topHdg,RECT *sideHdg,
		RECT *cnrBtn,RECT *vScroll,RECT *hScroll,RECT *tabs)
{
	...
	try
	{
		...
		if (GetNumberCols() == 3)
		{
			int nRemainingWidth = grid->right - grid->left;

			// Determine the combined width of all columns except the description column.
			for (int i = 0; i < 2; i++)
			{
				nRemainingWidth -= GetColWidth(i);
			}

			// Set the description column to occupy the remaining width.
			CHECK_UG_RETURN_VALUE("ELI32983", SetColWidth(2, nRemainingWidth));
		}
	}
	CATCH_AND_DISPLAY_ALL_EXCEPTIONS("ELI32984");
} 
//--------------------------------------------------------------------------------------------------
//	OnDrawFocusRect
...
//	Return:
//		<none>
void CRuleGrid::OnDrawFocusRect(CDC *dc,RECT *rect)
{
	AFX_MANAGE_STATE(AfxGetModuleState());
	...
	CATCH_AND_DISPLAY_ALL_EXCEPTIONS("ELI32985");
}
//--------------------------------------------------------------------------------------------------
//	OnGetDefBackColor
...
COLORREF CRuleGrid::OnGetDefBackColor(int section)
{
	UNREFERENCED_PARAMETER(section);
...
//		<none>
//
void CRuleGrid::OnSetFocus(int section)
{
	UNREFERENCED_PARAMETER(section);
}
//--------------------------------------------------------------------------------------------------
...
//	Return:
//		<none>
void CRuleGrid::OnKillFocus(int section, CWnd *pNewWnd)
{
	UNREFERENCED_PARAMETER(section);
}
//--------------------------------------------------------------------------------------------------
...
BOOL CRuleGrid::OnColSwapStart(int col)
{
	UNREFERENCED_PARAMETER(col);
	return TRUE;
}
...
//		TRUE - to allow for the swap to take place
//		FALSE - to disallow the swap
BOOL CRuleGrid::OnCanColSwap(int fromCol,int toCol)
{
...
//	Return:
//		<none>
void CRuleGrid::OnColSwapped(int fromCol,int toCol)
{
	UNREFERENCED_PARAMETER(fromCol);
	UNREFERENCED_PARAMETER(toCol);
}
...
//	Return:
//		<none>
void CRuleGrid::OnTrackingWindowMoved(RECT *origRect,RECT *newRect)
{
	UNREFERENCED_PARAMETER(*origRect);
	UNREFERENCED_PARAMETER(*newRect);
}
//--------------------------------------------------------------------------------------------------
void CRuleGrid::InsertRow(int index)
{
	AFX_MANAGE_STATE(AfxGetModuleState());

	try
	{
		ASSERT_ARGUMENT("ELI32986", index >= 0 && index <= GetNumberRows())

		CHECK_UG_RETURN_VALUE("ELI32987", EnableUpdate(FALSE));

		CHECK_UG_RETURN_VALUE("ELI32988", CUGCtrl::InsertRow(index));

		CUGCell cell;
		CHECK_UG_RETURN_VALUE("ELI32989", cell.CopyInfoFrom(m_GI->m_gridDefaults));
		CHECK_UG_RETURN_VALUE("ELI32990", cell.SetFont(&m_font));

		// Enabled
		CHECK_UG_RETURN_VALUE("ELI32991", cell.SetCellType(UGCT_CHECKBOX));
		CHECK_UG_RETURN_VALUE("ELI32992",
			cell.SetCellTypeEx(UGCT_CHECKBOXCHECKMARK | UGCT_CHECKBOXUSEALIGN));
		CHECK_UG_RETURN_VALUE("ELI32993", cell.SetAlignment(UG_ALIGNCENTER|UG_ALIGNVCENTER));
		CHECK_UG_RETURN_VALUE("ELI32994", SetCell(0, index, &cell));

		// Ignore error
		CHECK_UG_RETURN_VALUE("ELI32995", SetCell(1, index, &cell));

		// Description
		CHECK_UG_RETURN_VALUE("ELI32996", cell.SetCellType(UGCT_NORMAL));
		CHECK_UG_RETURN_VALUE("ELI32997", cell.SetAlignment(UG_ALIGNLEFT));
		CHECK_UG_RETURN_VALUE("ELI32998", SetCell(2, index, &cell));

		CHECK_UG_RETURN_VALUE("ELI32999", EnableUpdate(TRUE));
		CHECK_UG_RETURN_VALUE("ELI33000", RedrawAll());
	}
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI33001");
}
//--------------------------------------------------------------------------------------------------
void CRuleGrid::SetRowInfo(int nRow, bool bEnabled, bool bIgnoreError, const CString& zDescription)
{
	AFX_MANAGE_STATE(AfxGetModuleState());
	...
	try
	{
		...
		CHECK_UG_RETURN_VALUE("ELI33002", EnableUpdate(FALSE));

		CHECK_UG_RETURN_VALUE("ELI33003", QuickSetText(0, nRow, bEnabled ? "1" : "0"));
		CHECK_UG_RETURN_VALUE("ELI33004", QuickSetText(1, nRow, bIgnoreError ? "1" : "0"));
		CHECK_UG_RETURN_VALUE("ELI33005", QuickSetText(2, nRow, zDescription));

		CHECK_UG_RETURN_VALUE("ELI33006", EnableUpdate(TRUE));
		Invalidate();
	}
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI33007");
}
//--------------------------------------------------------------------------------------------------
bool CRuleGrid::GetEnabled(int nRowIndex)
{
	AFX_MANAGE_STATE(AfxGetModuleState());
	...
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI33008");
}
//--------------------------------------------------------------------------------------------------
void CRuleGrid::SetEnabled(int nRowIndex, bool bEnabled)
{
	AFX_MANAGE_STATE(AfxGetModuleState());

	try
	{
		CHECK_UG_RETURN_VALUE("ELI33009", QuickSetText(0, nRowIndex, bEnabled ? "1" : "0"));
	}
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI33010");
}
//--------------------------------------------------------------------------------------------------
bool CRuleGrid::GetIgnoreError(int nRowIndex)
{
	AFX_MANAGE_STATE(AfxGetModuleState());

	try
	{
		string text = QuickGetText(1, nRowIndex);

		return (text == "1");
	}
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI33011");
}
//--------------------------------------------------------------------------------------------------
void CRuleGrid::SetIgnoreError(int nRowIndex, bool bIgnoreError)
{
	AFX_MANAGE_STATE(AfxGetModuleState());

	try
	{
		CHECK_UG_RETURN_VALUE("ELI33012", QuickSetText(1, nRowIndex, bIgnoreError ? "1" : "0"));
	}
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI33013");
}
//--------------------------------------------------------------------------------------------------
CString CRuleGrid::GetDescription(int nRowIndex)
{
	AFX_MANAGE_STATE(AfxGetModuleState());

	try
	{
		return QuickGetText(2, nRowIndex);
	}
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI33014");
}
//--------------------------------------------------------------------------------------------------
void CRuleGrid::SetDescription(int nRowIndex, CString zDescription)
{
	AFX_MANAGE_STATE(AfxGetModuleState());

	try
	{
		CHECK_UG_RETURN_VALUE("ELI33015", QuickSetText(2, nRowIndex, zDescription));
	}
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI33016");
}
//--------------------------------------------------------------------------------------------------
int CRuleGrid::GetFirstSelectedRow()
{
	AFX_MANAGE_STATE(AfxGetModuleState());
	...
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI33017");
}
//--------------------------------------------------------------------------------------------------
int CRuleGrid::GetNextSelectedRow()
{
	AFX_MANAGE_STATE(AfxGetModuleState());
	...
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI33018");
}
//--------------------------------------------------------------------------------------------------
void CRuleGrid::SelectRow(int nRowIndex)
{
	AFX_MANAGE_STATE(AfxGetModuleState());
	
	try
	{
		CHECK_UG_RETURN_VALUE("ELI33019", SelectRange(0, nRowIndex, 1, nRowIndex));
	}
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI33020");
}
//--------------------------------------------------------------------------------------------------

...
//--------------------------------------------------------------------------------------------------
CIdentifiableRuleObject::CIdentifiableRuleObject()
: m_upGUID(__nullptr)
{
	try
	{
...
//--------------------------------------------------------------------------------------------------
void CIdentifiableRuleObject::loadGUID(IStream *pStream)
{
	try
	{
		...
		{
			// Throw exception
			UCLIDException ue("ELI33627", "Unable to load newer IdentifiableRuleObject!");
...
//--------------------------------------------------------------------------------------------------
void CIdentifiableRuleObject::saveGUID(IStream * pStream)
{
	try
	{
...
// Private functions
//-------------------------------------------------------------------------------------------------
void CIdentifiableRuleObject::validateLicense()
{
	VALIDATE_LICENSE(gnRULE_WRITING_CORE_OBJECTS, "ELI33519", "Rule set profiler");
}
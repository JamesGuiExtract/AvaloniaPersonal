...
public:
	...
	STDMETHOD(get_ReplacementValues)(IIUnknownVector** ppvecReplacements);
	STDMETHOD(put_ReplacementValues)(IIUnknownVector* pvecReplacements);
	STDMETHOD(get_PrefixText)(BSTR* pbstrPrefixText);
	STDMETHOD(put_PrefixText)(BSTR bstrPrefixText);
	STDMETHOD(get_SuffixText)(BSTR* pbstrSuffixText);
	STDMETHOD(put_SuffixText)(BSTR bstrSuffixText);

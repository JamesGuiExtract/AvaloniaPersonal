...
// Version 19: https://extract.atlassian.net/browse/ISSUE-18921 - Add indexes to labde tables.
// WARNING -- When the version is changed, the corresponding switch handler needs to be updated, see WARNING!!!
static const long glLABDE_DB_SCHEMA_VERSION = 19;
	...
	IProgressStatusPtr ipProgressStatus)
{
	try
	{
		...
		vector<string> vecQueries;
		vecQueries.push_back(gstrRENAME_EXISTING_LABDE_ENCOUNTER_INDEXES);
...
//-------------------------------------------------------------------------------------------------
int UpdateToSchemaVersion19(_ConnectionPtr ipConnection,
	long* pnNumSteps,
	IProgressStatusPtr ipProgressStatus)
{
	try
	{
		int nNewSchemaVersion = 19;
		...
		vecQueries.push_back(gstrRENAME_MANUALLY_CREATED_INDEXES);
		vecQueries.push_back(gstrCREATE_LABDE_PROVIDER_OTHER_PROVIDER_ID_INDEX);
		vecQueries.push_back(gstrCREATE_LABDE_PATIENT_MERGED_INTO_INDEX);
		vecQueries.push_back(gstrCREATE_LABDE_PROVIDER_ID_INDEX);
		vecQueries.push_back(gstrCREATE_LABDE_PROVIDER_FIRST_MIDDLE_LAST_PROVIDER_INACTIVE_ID);
		vecQueries.push_back(gstrCREATE_LABDE_PROVIDER_PROVIDER_INACTIVE);
	...
	CATCH_ALL_AND_RETHROW_AS_UCLID_EXCEPTION("ELI53995");
}
	...
	VARIANT_BOOL bAddUserTables)
{
	try
	{
		...
		vecCreateQueries.push_back(gstrCREATE_LABDE_PROVIDER_OTHER_PROVIDER_ID_INDEX);
		vecCreateQueries.push_back(gstrCREATE_LABDE_PATIENT_MERGED_INTO_INDEX);
		vecCreateQueries.push_back(gstrCREATE_LABDE_PROVIDER_ID_INDEX);
		vecCreateQueries.push_back(gstrCREATE_LABDE_PROVIDER_FIRST_MIDDLE_LAST_PROVIDER_INACTIVE_ID);
		vecCreateQueries.push_back(gstrCREATE_LABDE_PROVIDER_PROVIDER_INACTIVE);
	...
	IProgressStatus* pProgressStatus)
{
	try
	{
		...
		case 17:
			...
			break;
		case 18:
			// The schema update from 18 to 19 needs to take place using FAM DB schema version 221
			if (nFAMDBSchemaVersion == 221)
			{
				*pnProdSchemaVersion = UpdateToSchemaVersion19(ipConnection, pnNumSteps, NULL);
			}
			break;
		case 19:
			break;

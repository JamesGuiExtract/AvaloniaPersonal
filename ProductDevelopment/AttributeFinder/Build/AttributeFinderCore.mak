...
CopyFilesToInstallFolder: BuildPDUtils ObfuscateFiles
	...
	@COPY /V /Y "$(RCNETDir)\APIs\DevExpress\v22.1\*.*" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
	@COPY /V /Y "$(RCNETDir)\APIs\DevExpress\v22.1\*.*" "$(AFCoreInstallFilesRootDir)\DotNetGAC"

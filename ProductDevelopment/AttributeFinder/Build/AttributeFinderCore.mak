...
SetVersions:
    ...
    @SendFilesAsArgumentToApplication Directory.Build.props 1 1 $(UpdateFileVersion) "$(FlexIndexVersion)"
    @CD "$(RCNETDir)"
...
#    Copy the strong naming key to location dotfuscator xml file expects
    ...
    dotfuscator.exe /nologo /in:"$(BinariesFolder)\Extract.AlternateTestNameManagerPlugin.dll" /mapout:"$(BinariesFolder)\Map\mapExtract.AlternateTestNameManagerPlugin.xml" /encrypt:on /enhancedOI:on /out:"$(BinariesFolder)\Obfuscated" $(PDCommonDir)\ObfuscateConfig.xml
...
CopyFilesToInstallFolder: BuildPDUtils ObfuscateFiles
    ...
    @COPY /V /Y "$(BinariesFolder)\Handlebars.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
    @COPY /V /Y "$(BinariesFolder)\Handlebars.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
    ...
    @COPY /V /Y "$(BinariesFolder)\Microsoft.Graph.Core.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
    @COPY /V /Y "$(BinariesFolder)\Extract.Utilities.Authentication.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
    @COPY /V /Y "$(BinariesFolder)\Microsoft.Identity.Client.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
    @COPY /V /Y "$(BinariesFolder)\Microsoft.IdentityModel.*.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
    @COPY /V /Y "$(BinariesFolder)\Microsoft.Identity.Client.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
    @COPY /V /Y "$(BinariesFolder)\Microsoft.IdentityModel.*.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
    ...
    @COPY /V /Y  "$(BinariesFolder)\System.Data.SqlServerCe.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
    @COPY /V /Y  "$(BinariesFolder)\Obfuscated\Extract.AlternateTestNameManagerPlugin.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
    ...
    @COPY /V /Y "$(RCNETDir)\APIs\DevExpress\v21.1\*.*" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
    @COPY /V /Y "$(RCNETDir)\APIs\DevExpress\v21.1\*.*" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
    @COPY /V /Y "$(BinariesFolder)\Lucene.Net.*" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
    @COPY /V /Y "$(BinariesFolder)\Lucene.Net.*" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
    @COPY /V /Y "$(BinariesFolder)\Prism.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
    @COPY /V /Y "$(BinariesFolder)\Prism.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
    @COPY /V /Y "$(BinariesFolder)\J2N.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
    @COPY /V /Y "$(BinariesFolder)\J2N.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
    ...
    @COPY /V /Y "$(RCNETDir)\APIs\Oracle\*.*" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
...
# Copy WindowsAPICodePack to DotNetGAC for installshield
    ...
    @COPY /V /Y "$(BinariesFolder)\System.Threading.Tasks.Extensions.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
    ...
    @COPY /V /Y "$(BinariesFolder)\MimeKitLite.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
    @COPY /V /Y "$(BinariesFolder)\Polly.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
    @COPY /V /Y "$(BinariesFolder)\Polly.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
...
# Add .net com objects to the .nl file
    ...
    @DIR "$(AFCoreInstallFilesRootDir)\DotNetGAC\Extract.GdPicture.dll" /b >>"$(AFCoreInstallFilesRootDir)\NonSelfRegFiles\AFCore.nl"

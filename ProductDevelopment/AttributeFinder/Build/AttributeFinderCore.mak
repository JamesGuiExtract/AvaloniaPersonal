...
CopyFilesToInstallFolder: BuildPDUtils ObfuscateFiles
	...
	@COPY /V /Y "$(BinariesFolder)\Extract.Utilities.EmailGraphAPI.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
	...
	@COPY /V /Y "$(BinariesFolder)\MailKit.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
	@COPY /V /Y "$(BinariesFolder)\Extract.Utilities.EmailGraphAPI.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
	...
	@COPY /V /Y "$(BinariesFolder)\MailKit.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
	@COPY /V /Y "$(BinariesFolder)\Extract.Utilities.Authentication.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
	@COPY /V /Y "$(BinariesFolder)\Microsoft.Identity.Client.Desktop.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
	...
	@COPY /V /Y "$(BinariesFolder)\Microsoft.Identity.Client.Desktop.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"

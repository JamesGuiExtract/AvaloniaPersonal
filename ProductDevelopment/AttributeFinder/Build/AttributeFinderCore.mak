...
CopyFilesToInstallFolder: BuildPDUtils ObfuscateFiles
	...
	@COPY /V /Y "$(BinariesFolder)\Extract.Utilities.Email.GraphClient.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
	...
	@COPY /V /Y "$(BinariesFolder)\MimeKit.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
	...
	@COPY /V /Y "$(BinariesFolder)\MimeKit.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"

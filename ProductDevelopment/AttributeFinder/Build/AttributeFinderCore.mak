...
CopyFilesToInstallFolder: BuildPDUtils BuildDashboards ObfuscateFiles
	...
	@COPY /v /y  "$(BinariesFolder)\Extract.Attribute.Rules.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
	...
	@COPY "$(RCNETDir)\APIs\DevExpress\v18.2\*.*" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"

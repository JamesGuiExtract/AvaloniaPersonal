...
CopyFilesToInstallFolder: BuildPDUtils BuildDashboards ObfuscateFiles
	...
	@COPY /v "$(BinariesFolder)\DatabaseMigrationWizard.exe" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
	...
	@COPY /v "$(BinariesFolder)\Extract.AttributeFinder.Rules.Domain.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
	@COPY /v "$(BinariesFolder)\Extract.AttributeFinder.Rules.Dto.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
	@COPY /v "$(BinariesFolder)\Extract.AttributeFinder.Rules.Json.dll" "$(AFCoreInstallFilesRootDir)\DotNetGAC"
	@COPY /v  "$(BinariesFolder)\ResolutionNormalizer2.exe" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
	...
	@COPY "$(RCNETDir)\APIs\DevExpress\v19.2\*.*" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
	...
	@COPY "$(BinariesFolder)\GalaSoft*.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"
	@COPY "$(BinariesFolder)\FirstFloor*.dll" "$(AFCoreInstallFilesRootDir)\NonSelfRegFiles"

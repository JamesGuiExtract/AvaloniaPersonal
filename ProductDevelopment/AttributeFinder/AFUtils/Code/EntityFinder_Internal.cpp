...
//-------------------------------------------------------------------------------------------------
UCLID_AFUTILSLib::IEntityFinderPtr CEntityFinder::getThisAsCOMPtr()
{
	UCLID_AFUTILSLib::IEntityFinderPtr ipThis(this);
	ASSERT_RESOURCE_ALLOCATION("ELI16966", ipThis != NULL);
...
//-------------------------------------------------------------------------------------------------
bool CEntityFinder::removeAddressText(ISpatialStringPtr ripText)
{
	bool bFound = false;

	// Trim any leading digits
	//  otherwise they can be recognized as part of an address

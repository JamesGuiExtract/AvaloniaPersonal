...
#import "..\..\..\..\..\ReusableComponents\COMComponents\UCLIDRasterAndOCRMgmt\OCREngines\SSOCR\Code\SSOCR.tlb" named_guids, raw_property_prefixes("raw_get_", "raw_put_", "raw_putref_")

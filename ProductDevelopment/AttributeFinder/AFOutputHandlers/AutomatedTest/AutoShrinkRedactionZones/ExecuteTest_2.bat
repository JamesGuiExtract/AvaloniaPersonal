...
START "" "%CommonComponentsDir%\CopyNumberedFiles.exe" ".\rotation_orientation_skew.tif" ".\Source" 10s -h4

REM Execute command-line for desired test
START "" "%CommonComponentsDir%\ProcessFiles.exe" MemoryLeak_2.fps /s

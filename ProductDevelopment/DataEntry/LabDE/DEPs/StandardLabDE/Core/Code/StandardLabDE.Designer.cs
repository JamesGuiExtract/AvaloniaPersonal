namespace Extract.DataEntry.DEP.StandardLabDE
{
    ...
    "ute>,1,30) ORDER BY MiddleName</SQL>";
            ...
            this._physicianTable.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle16;
            ...
            this._physicianTable.DefaultCellStyle = dataGridViewCellStyle17;
            ...
            this._physicianTable.RowHeadersDefaultCellStyle = dataGridViewCellStyle18;
    ...
    "ute>,1,30) ORDER BY MiddleName</SQL>";
            ...
            this._testResultTime.AutoUpdateQuery = resources.GetString("_testResultTime.AutoUpdateQuery");
            ...
            this._testResultTime.ValidationErrorMessage = "Result time must be a valid time formatted HH:MM";
            this._testResultTime.ValidationPattern = "(^$)|(^((0?[0-9])|(1[0-9])|(2[0-3])):[0-5][0-9]$)";
            this._testResultTime.ValidationQuery = "";
            // 
            // _resultDateLabel
            // 
            ...
            this._testResultDate.AutoUpdateQuery = resources.GetString("_testResultDate.AutoUpdateQuery");
            ...
            this._testResultDate.ValidationErrorMessage = "Result date must be a valid date formatted MM/DD/YYYY";
            this._testResultDate.ValidationPattern = "^((0?[1-9])|(1[0-2]))/((0?[1-9])|(1[0-9])|(2[0-9])|(3[01]))/(19|20)\\d{2}$";
            this._testResultDate.ValidationQuery = "";
            // 
            // _testsGroupBox
            // 
            ...
            this._filename.Size = new System.Drawing.Size(506, 20);
            ...
            this._copyButton.Location = new System.Drawing.Point(519, 94);

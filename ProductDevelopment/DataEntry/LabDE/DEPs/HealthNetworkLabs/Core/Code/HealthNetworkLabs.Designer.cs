namespace Extract.DataEntry.DEP.HealthNetworkLabs
{
    ...
    "y>";
            ...
            this._componentValue.AutoUpdateQuery = "<Expression>\r\n(<Attribute>../TestCode</Attribute> == \'DICOM\')\r\n\t? \'DICLC\'\r\n\t: \'\'\r" +
    "\n</Expression>";
            ...
            this._componentRefRange.ValidationErrorMessage = "Reference range is not allowed for this result.";
            this._componentRefRange.ValidationQuery = resources.GetString("_componentRefRange.ValidationQuery");
            // 
            // _componentFlag
            // 

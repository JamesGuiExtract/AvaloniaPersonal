...
namespace Extract.SharePoint
{
    ...
    public enum ErrorCategoryId
    {
        ...
        /// <summary>
        /// Error occurred in the timer job Disk to SharePoint
        /// </summary>
        IdShieldDiskToSharePoint = 9,

        /// <summary>
        /// Error occurred in the timer job SharePoint to Disk
        /// </summary>
        IdShieldSharePointToDisk = 10,

        /// <summary>
        /// Error occurred in the redact now helper page
        /// </summary>
        IdShieldRedactNowHelper = 11,

        /// <summary>
        /// Error occurred when communicating with the local ID Shield for
        /// SP client application.
        /// </summary>
        IdShieldRedactNowClientLaunch = 12,

        /// <summary>
        /// Error occurred in the ID Shield file receiver
        /// </summary>
        DataCaptureFileReceiver = 13,

        /// <summary>
        /// Error occurred in the ID Shield settings configuration
        /// </summary>
        DataCaptureSettingsConfiguration = 14,

        /// <summary>
        /// Error occurred in the watch folder configuration
        /// </summary>
        DataCaptureWatchFolderConfiguration = 15,

        /// <summary>
        /// Error occurred in the remove folder watch configuration
        /// </summary>
        DataCaptureRemoveFolderWatch = 16,

        /// <summary>
        /// Error occurred in the timer job Disk to SharePoint
        /// </summary>
        DataCaptureDiskToSharePoint = 17,

        /// <summary>
        /// Error occurred in the timer job SharePoint to Disk
        /// </summary>
        DataCaptureSharePointToDisk = 18,

        /// <summary>
        /// Error occurred in the redact now helper page
        /// </summary>
        DataCaptureRedactNowHelper = 19,
    }

...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfigureIdShieldSettings.aspx.cs" Inherits="Extract.SharePoint.Redaction.Administration.Layouts.ConfigureIdShieldSettings" MasterPageFile="~/_admin/admin.master" %>

<asp:Content id="PageHead" ContentPlaceHolderid="PlaceHolderAdditionalPageHead" runat="server">
</asp:Content>

<asp:Content id="Main" ContentPlaceHolderid="PlaceHolderMain" runat="server">
<asp:Panel id="panelLogo" runat="server" forecolor="Black" groupingtext="ID Shield Version: Unknown" >
    <asp:Image runat="server" imageurl="/_layouts/images/Extract.SharePoint.Redaction/IdShieldLogo.jpg"
         imagealign="middle" />
</asp:Panel>
...
<table>
    ...
    <tr>
        <td>
            <asp:Label id="labelFpsFileLocation" runat="server" forecolor="Black"
                text="Location for ID Shield for SharePoint Client FPS file." />
        </td>
    </tr>
    <tr>
        <td>
            <asp:TextBox id="textFpsFileLocation" runat="server" width="450" />
        </td>
    </tr>
    <tr>
        <td>
...
<br />
<asp:Panel id="panelWatchedFolders" runat="server" groupingtext="ID Shield folder settings"
    forecolor="Black">
    <table>
        <tr>
            <td>

...
<script runat="server">
    public void CheckOutputOptions(object source, ServerValidateEventArgs e)
    {
        ...
        else if (radioMirrorLibrary.Checked)
        {
            ...
            // It also cannot be the name of the current list [FIDSI #247]
            ...
            valid = !text.Equals("sites", StringComparison.OrdinalIgnoreCase)
                ...
                && !text.Equals(hiddenListName.Value, StringComparison.OrdinalIgnoreCase);
        }
        ...
        <table>
            ...
            <tr>
                ...
                <asp:RadioButton ID="radioMirrorLibrary" runat="server" GroupName="RadioOutputPath"
                        Text="Use identical folder structure in document library with internal name"

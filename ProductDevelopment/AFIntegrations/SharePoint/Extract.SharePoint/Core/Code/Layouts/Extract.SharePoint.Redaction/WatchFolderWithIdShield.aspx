...
<script runat="server">
    ...
    public void CheckOutputOptions(object source, ServerValidateEventArgs e)
    {
        ...
        e.IsValid = !string.IsNullOrEmpty(text) && !text.Contains("/");
    }
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <asp:Panel ID="panelFileSpecification" runat="server"
        GroupingText="Input file specification" ForeColor="Black">
    <table>
        <tr>
            <td>
                <asp:Label ID="labelFolderName" runat="server" Text="Current folder:"
                    ForeColor="Black" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <asp:Label ID="labelFileExtension" runat="server"
                    Text="File extension specification" ForeColor="Black" />
            </td>
        </tr>
        <tr>
            <td>
                ...
                ControlToValidate="textFileExtension" ErrorMessage="File extension is required." />
            </td>
        </tr>
        <tr><td></td></tr>
    </table>
    ...
    <br />
    <asp:Panel ID="panelFolderSettings" runat="server"
        GroupingText="Folder settings" ForeColor="Black">
    <table>
        <tr>
            <td>
                <asp:CheckBox ID="checkRecursively" runat="server" ForeColor="Black"
                    Text="Recursively process files from any sub folders" AutoPostback="false"/>
            </td>
        </tr>
        <tr>
            <td>
                <asp:CheckBox ID="checkAdded" runat="server" ForeColor="Black"
                    Text="Process any files that are added" AutoPostback="false"/>
            </td>
        </tr>
        <tr>
            <td>
                <asp:CheckBox ID="checkModified" runat="server" ForeColor="Black"
                    Text="Process any files that are modified" AutoPostback="false"/>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <br />
    <asp:Panel ID="panelOutputSettings" runat="server"
        GroupingText="Output settings" ForeColor="Black">
    <table>
        <tr>
            <td>
            <asp:RadioButton ID="radioParallel" runat="server" GroupName="RadioOutputPath"
                ...
                AutoPostBack="true"
                />
            <asp:DropDownList ID="dropFolderName" runat="server" ForeColor="Black"
        ...
        <tr>
            <td>
                <asp:RadioButton ID="radioSameFolder" runat="server" GroupName="RadioOutputPath"
                    ...
                    AutoPostBack="true"
                />
                <asp:DropDownList ID="dropFileName" runat="server" ForeColor="Black"
        ...
        <tr>
            <td>
                <asp:CustomValidator runat="server" ControlToValidate="textCurrentFolderName"
                    ErrorMessage="Output setting must not be blank or contain '/' (unless using custom location)"
    ...
    <asp:Panel ID="panelButtons" runat="server" HorizontalAlign="Right">
        ...
        <asp:Button ID="buttonCancel" runat="server" Text="Cancel"
            OnClientClick="HandleCancelClicked()"  />
    </asp:Panel>
</asp:Content>

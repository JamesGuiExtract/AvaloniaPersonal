...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfigureIdShieldSettings.aspx.cs" Inherits="Extract.SharePoint.Layouts.Extract.SharePoint.Redaction.ConfigureIdShieldSettings" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <br />
    <asp:TextBox ID="txtFolder" runat="server" Width="450" />

...
namespace WebAPI
{
    ...
    public class FileApiMgr : IFileApiMgr
    {
        ...
        public IFileApi GetInterface(ApiContext apiContext, ClaimsPrincipal sessionOwner = null)
        {
            ...
            {
                int.TryParse(sessionOwner.GetClaim("FAMSessionId"), out requestedFAMSessionID);
        ...
        {
            // Try first to look up an instance that was specifically associated with apiContext.
